...
function Vision() {
    return (
        ...
        {/* Left Image Section */}
        <div className="relative h-[260px] w-full lg:h-auto lg:w-1/3 lg:block hidden">
          <Image
        ...
        <div className="relative flex w-full flex-col justify-center bg-black px-6 py-10 text-white md:px-15 lg:w-2/3">
          ...
          {/* Quote icons */}
          <span className="absolute left-2 md:left-8 top-6 md:text-6xl text-4xl text-[#00A3E0]">“</span>
