  ...
  />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
        Build Your Future With Technogetic
          </motion.h1>
          ...
          >
Join a team building scalable digital solutions that drive real impact and turn ideas into meaningful careers.</motion.p>
