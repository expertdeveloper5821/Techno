  ...
  />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
         Technology Solutions for E-Commerce Businesses
          </motion.h1>
          ...
          >
We help e-commerce businesses build faster, smarter, and more reliable platforms that improve customer experience, increase conversions, and simplify day-to-day operations.</motion.p>
          ...
          >
            ...
            >
              <p className='p-0 m-0' > <span className='text-[#CECECE]'>Home</span>  <ChevronRightIcon width={7} height={11} color="#CECECE" className="inline-block transition-transform duration-500 ease-out group-hover:translate-x-0.5" />career</p>
            </motion.a>
          </motion.div>
        </div>
      </div>
