...
//                   </div>
//                   <div className="p-2">
//                     <article className="bg-[#0094DB] h-[450px] sm:h-[350px] w-full rounded-2xl px-2 py-7 sm:px-7 sm:py-9 md:px-8 md:py-6 lg:px-2 lg:py-2 shadow-[0_20px_60px_rgba(0,0,0,0.5)] flex flex-col my-4">
