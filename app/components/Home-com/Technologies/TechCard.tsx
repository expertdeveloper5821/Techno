...
export default function TechCard({ tech }: { tech: { name: string; logo: string; description: string } }) {
  return (
    <div className="bg-[#0A0A0A]   md:w-[500px] w-[500px] border border-[#282926] p-4 rounded-lg flex items-start gap-5 hover:border-white/10 hover:bg-[#1a1a1a] transition-all duration-300 h-full group cursor-pointer">
      {/* Logo Box */}
