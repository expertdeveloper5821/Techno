...
export default function TechCard({ tech }: { tech: { name: string; logo: string; description: string } }) {
  return (
    <div className="bg-[#282926]   md:w-[500px] w-[500px] border border-white/5 p-4 rounded-lg flex items-start gap-5 hover:border-white/10 hover:bg-[#1a1a1a] transition-all duration-300 h-full group cursor-pointer">
      {/* Logo Box */}
