...
import { getContactBlocks } from '@/app/lib/data/site-contact';
...
export interface ContactFormCardProps {
  ...
  /** When set, shown instead of the generic error line */
...
export default function ContactFormCard({
  ...
  const contactBlocks = getContactBlocks().map((block) => ({
    ...block,
    icon: contactIcons[block.title],
  }));
