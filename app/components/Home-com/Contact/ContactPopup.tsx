  ...
  return (
    <>
      ...
      >
        ...
        {/* Modal card */}
        <div className="relative w-full max-w-lg overflow-y-auto rounded-2xl bg-[#0094DB] p-6 sm:p-8 shadow-2xl">
          <button
            type="button"
            onClick={closePopup}
          ...
          <h2 id="contact-popup-title" className="text-2xl font-bold text-white mb-4 pr-10">
            Get in touch
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="popup-firstName" className="block text-white text-sm font-medium mb-1.5">First name</label>
                <input id="popup-firstName" type="text" name="firstName" value={formData.firstName} onChange={handleChange} placeholder="First name"
              ...
              <div>
                <label htmlFor="popup-lastName" className="block text-white text-sm font-medium mb-1.5">Last name</label>
                <input id="popup-lastName" type="text" name="lastName" value={formData.lastName} onChange={handleChange} placeholder="Last name"
                  className="w-full px-4 py-2 rounded-lg bg-[#0ea5e9]/20 border border-white/40 text-white placeholder-gray-300 focus:border-white focus:outline-none focus:ring-1 focus:ring-white/50 transition-colors" />
              </div>
            </div>

            <div>
              <label htmlFor="popup-email" className="block text-white text-sm font-medium mb-1.5">Email</label>
              <input id="popup-email" type="email" name="email" value={formData.email} onChange={handleChange} placeholder="you@company.com"
                className="w-full px-4 py-2 rounded-lg bg-[#0ea5e9]/20 border border-white/40 text-white placeholder-gray-300 focus:border-white focus:outline-none focus:ring-1 focus:ring-white/50 transition-colors" />
            </div>

            <div>
              <label htmlFor="popup-phone" className="block text-white text-sm font-medium mb-1.5">Phone number</label>
              <div className="flex rounded-lg overflow-hidden border border-white/40 bg-[#0ea5e9]/20 focus-within:border-white focus-within:ring-1 focus-within:ring-white/50">
                <select name="countryCode" aria-label="Country code" className="px-3 py-2 bg-transparent text-white text-sm border-r border-white/40 focus:outline-none">
                ...
                <input id="popup-phone" type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+91000-0000"
                  className="flex-1 min-w-0 px-4 py-2 bg-transparent text-white placeholder-gray-300 focus:outline-none" />
              </div>
            </div>

            <div>
              <label htmlFor="popup-message" className="block text-white text-sm font-medium mb-1.5">Message</label>
              <textarea id="popup-message" name="message" value={formData.message} onChange={handleChange} placeholder="Leave us a message..." rows={3}
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-white/90 text-sm">You agree to our friendly privacy policy.</span>
            </label>
