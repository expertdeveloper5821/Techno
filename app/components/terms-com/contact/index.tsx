          ...
          >
            ...
            <div className="mx-auto overflow-hidden relative w-full flex flex-col items-center  gap-0 md:flex-row bg-[#0094DB]  rounded-2xl ">
              ...
              <div className=" text-white p-10 lg:pr-0">
                ...
                Didn’t find the answer you were looking for? Our team is here to help. Reach out to us and get clear guidance tailored to your project needs.
                </p>
                ...
                >
                  Talk to Our Team <ChevronRightIcon width={7} height={11} color="#000000" className="inline-block transition-transform duration-500 ease-out group-hover:translate-x-0.5" />
                </a>
              </div>
