...
export default function Contact() {
  return (
    <section className="relative overflow-hidden flex flex-col justify-start lg:pt-24 lg:pb-24 md:pt-15 md:pb-15 pt-10 pb-10 bg-[#000000]">
      <div className="w-full flex flex-col gap-0 mx-auto px-4 sm:px-6 lg:px-6">
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          <div className="mx-auto overflow-hidden relative w-full flex flex-col items-center gap-0 md:flex-row bg-[#0094DB] rounded-2xl">
            ...
            <div className="text-white p-10 lg:pr-0">
              ...
              <p className="mb-6 text-base sm:text-[20px] text-white/90 md:text-base leading-relaxed">
                If you have any questions or concerns about our Terms &amp; Conditions, our team is ready to help. Reach out and we&apos;ll get back to you promptly.
              </p>
              <a
                href="#contact"
            ...
            <div className="relative h-[260px] w-full max-w-[320px] md:h-[400px] md:max-w-[380px] lg:block hidden">
              <Image
                src="/About/contact/contact.webp"
