    ...
    <section className="relative pt-40 pb-10 sm:pt-48 sm:pb-40 flex flex-col items-center justify-center overflow-hidden z-10 bg-[linear-gradient(180deg,#0094DB_0%,#036C9F_70.41%,#000000_94.02%)]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Please read these Terms &amp; Conditions carefully before using our services. By accessing or using Technogetic&apos;s services, you agree to be bound by these terms.
          </motion.p>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group inline-flex gap-2 items-center bg-transparent text-white px-3 md:px-6 py-1 md:py-2 rounded-full text-lg font-semibold transition-colors shadow-lg"
              style={{ border: '1px solid #B8B8B833' }}
            >
              <p className="p-0 m-0">
