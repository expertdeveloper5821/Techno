      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
        <div className="max-w-5xl mx-auto text-center">
         ...
         Terms of Service
          ...
          >
Welcome to Technogetic. By accessing or using our website and services, you agree to the following Terms of Service. Please read them carefully.</motion.p>
          ...
          >
            ...
            >
              <p className='p-0 m-0' > <span className='text-[#CECECE]'><a href='/' >Home</a></span>  <ChevronRightIcon width={7} height={11} color="#CECECE" className="inline-block transition-transform duration-500 ease-out group-hover:translate-x-0.5" />   Terms of Service</p>
            </motion.a>
          </motion.div>
        </div>
      </div>
