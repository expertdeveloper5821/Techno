...
import { termsTopics } from '../../../lib/data/terms-page-topics';
...
export default function Topics() {
  const [activeTopicId, setActiveTopicId] = useState(termsTopics[0]?.id ?? '');
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-lg px-4 py-3 text-left text-sm transition-all duration-200 sm:text-base ${isActive
                        ? 'bg-[#000000] text-[#F5F5F5] shadow-[0_0_0_1px_rgba(255,255,255,0.1)]'
                ...
                >
                  ...
                  <div className="relative mt-2 space-y-2">
                    ...
                    {topic.bullets?.length ? (
                      <ul className={`list-disc space-y-1 pl-4 text-sm leading-7 sm:text-lg ${palette.muted}`}>
