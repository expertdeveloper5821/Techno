  ...
  />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
        ...
        Insights That Help You Build Better Systems
          ...
          >
We share practical ideas, real project learnings, and simple solutions to business and technology problems we solve while working with clients.</motion.p>
          ...
          >
            ...
            >
              <p className='p-0 m-0' > <span className='text-[#CECECE]'><a href='/' >Home</a></span>  <ChevronRightIcon width={7} height={11} color="#CECECE" className="inline-block transition-transform duration-500 ease-out group-hover:translate-x-0.5" /> Blogs</p>
            </motion.a>
          </motion.div>
        </div>
      </div>
